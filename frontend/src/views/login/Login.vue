<template>
  <a-card :bordered="false" hoverable style="margin-top: 130px;background-color: #f9f9f9">
    <div style="text-align: left;font-size: 14px;margin-bottom: 30px"><b>朱家尖-自助旅游服务系统</b></div>
    <div class="login">
      <a-form @submit.prevent="doLogin" :autoFormCreate="(form) => this.form = form">
        ...
        <a-form-item>
          <a-button :loading="loading" style="width: 100%; margin-top: 4px" htmlType="submit" type="primary">
            登录
          </a-button>
        </a-form-item>
        <div>
